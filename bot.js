/* Copyright (C) 2020 Diwan Kawishka.

Licensed under the  GPL-3.0 License;
you may not use this file except in compliance with the License.

WhatsAsena - Diwan Kawishka
*/
...
const {Message, StringSession, Image, Video} = require('./diwanbase/');
...
${chalk.blue.italic('K BOT Connecting to WhatsApp😜...')}`);
    });
    

    conn.on('open', async () => {
        console.log(
            chalk.green.bold('K BOT Login successful😜!')
        );
        ...
        console.log(
            chalk.blueBright.italic('K BOT plugin Installing...')
        );
        ...
        console.log(
            chalk.green.bold('K BOT IS working🥰 Created by diwan!')
        );
    });
